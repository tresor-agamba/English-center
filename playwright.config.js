...
module.exports = defineConfig({
  ...
  webServer: { command: 'node src/server.js', url: `http://127.0.0.1:${responsivePort}/health`, timeout: 120000, reuseExistingServer: true, env: { ...process.env, PORT: responsivePort, NODE_ENV: 'test', PUBLIC_WHATSAPP_NUMBER: '243899999999' } },
