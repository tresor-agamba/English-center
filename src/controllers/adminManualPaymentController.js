...
function handle(res, error) {
  if (error instanceof service.ManualPaymentError) return res.status(error.statusCode).render('student/payment/error', { title: 'Paiement manuel', message: error.message, paymentErrorContext: 'admin', layoutContext: 'admin' });
  throw error;
}
