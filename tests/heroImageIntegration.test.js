...
test('photo optimisée intégrée au Hero public', () => {
  ...
  assert.match(view, /alt="Étudiant congolais suivant un cours d’anglais en ligne sur son ordinateur"/);
  ...
  assert.match(css, /\.hero-student-photo[^}]*object-fit:\s*cover/);
});
