...
const views = [
  'views/home.ejs', 'views/auth/login.ejs', 'views/auth/forgot-password.ejs', 'views/auth/reset-password.ejs', 'views/error.ejs', 'views/public/about.ejs', 'views/public/contact.ejs',
